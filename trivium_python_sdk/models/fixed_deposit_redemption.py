...
class FixedDepositRedemption(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["transactionId", "productId", "quantity", "currencyCode", "receivedAt", "status", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['FixedDepositRedemption']):
            raise ValueError("must be one of enum values ('FixedDepositRedemption')")
        return value
