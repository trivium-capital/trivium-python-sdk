...
class RedemptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["quantity", "currencyCode", "transferDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transferDetails": TransferDetails.from_dict(obj["transferDetails"]) if obj.get("transferDetails") is not None else None
        })
        return _obj
