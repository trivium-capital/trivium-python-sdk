...
class PortfolioPerformance(BaseModel):
    ...
    """ # noqa: E501
    series: Optional[List[PerformanceSnapshot]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "series": [PerformanceSnapshot.from_dict(_item) for _item in obj["series"]] if obj.get("series") is not None else None
        })
        return _obj
