...
class Deposit(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["accountId", "quantity", "currencyCode", "receivedAt", "status", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Deposit']):
            raise ValueError("must be one of enum values ('Deposit')")
        return value
