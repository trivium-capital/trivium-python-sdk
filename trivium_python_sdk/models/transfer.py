...
class Transfer(BaseModel):
    ...
    Transfer
    """ # noqa: E501
    var_from: TransferDetails = Field(alias="from")
    to: TransferDetails
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": TransferDetails.from_dict(obj["from"]) if obj.get("from") is not None else None,
            "to": TransferDetails.from_dict(obj["to"]) if obj.get("to") is not None else None
        })
        return _obj
