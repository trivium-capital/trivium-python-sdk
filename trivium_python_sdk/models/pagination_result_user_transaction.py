...
class PaginationResultUserTransaction(BaseModel):
    """
    PaginationResultUserTransaction
    """ # noqa: E501
    results: Optional[List[UserTransaction]] = None
    total_count: StrictInt = Field(alias="totalCount")
    has_next_page: StrictBool = Field(alias="hasNextPage")
    __properties: ClassVar[List[str]] = ["results", "totalCount", "hasNextPage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [UserTransaction.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
