...
class Swift(BaseModel):
    ...
    account_holder_address: Optional[StrictStr] = Field(default=None, alias="accountHolderAddress")
    bank_name: StrictStr = Field(alias="bankName")
    bank_address: Optional[StrictStr] = Field(default=None, alias="bankAddress")
    swift_code: StrictStr = Field(alias="swiftCode")
    reference: Optional[StrictStr] = None
    type: StrictStr
    __properties: ClassVar[List[str]] = ["accountNumber", "accountHolderName", "accountHolderAddress", "bankName", "bankAddress", "swiftCode", "reference", "type"]
