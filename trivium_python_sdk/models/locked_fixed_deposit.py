...
class LockedFixedDeposit(BaseModel):
    """
    LockedFixedDeposit
    """ # noqa: E501
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["placementId", "investedQuantity", "currentValue", "currencyCode", "providerDetails", "term", "redemptionDate", "returnAtMaturity", "lockedRate", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LockedFixedDeposit']):
            raise ValueError("must be one of enum values ('LockedFixedDeposit')")
        return value
