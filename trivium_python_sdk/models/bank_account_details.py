...
class BankAccountDetails(BaseModel):
    ...
    bank_country: StrictStr = Field(alias="bankCountry")
    bank_swift: StrictStr = Field(alias="bankSwift")
    ...
    __properties: ClassVar[List[str]] = ["paymentType", "currency", "bankName", "bankAccountHolderName", "bankAccountNumber", "bankCountry", "bankSwift", "routingCodeType1", "routingCodeValue1", "routingCodeType2", "routingCodeValue2"]
