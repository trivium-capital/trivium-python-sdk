...
class BankAccountDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["paymentType", "currency", "bankName", "bankAccountHolderName", "bankAccountNumber", "bankCountry", "routingCodeType1", "routingCodeValue1", "routingCodeType2", "routingCodeValue2"]
