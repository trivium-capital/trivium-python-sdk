...
class IndividualBeneficiaryDetails(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "address", "city", "state", "country", "postalCode", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['IndividualBeneficiaryDetails']):
            raise ValueError("must be one of enum values ('IndividualBeneficiaryDetails')")
        return value
