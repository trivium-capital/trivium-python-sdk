...
class Composition(BaseModel):
    ...
    Composition
    """ # noqa: E501
    classes: Optional[List[AssetClassProportion]] = None
    funds: Optional[List[Fund]] = None
    countries: Optional[List[CountryProportion]] = None
    __properties: ClassVar[List[str]] = ["classes", "funds", "countries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classes": [AssetClassProportion.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None,
            "funds": [Fund.from_dict(_item) for _item in obj["funds"]] if obj.get("funds") is not None else None,
            "countries": [CountryProportion.from_dict(_item) for _item in obj["countries"]] if obj.get("countries") is not None else None
        })
        return _obj
